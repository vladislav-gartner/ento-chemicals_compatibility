...
class m180523_151638_rbac_updates_indexes_without_prefix extends Migration
{
    ...
    public function up()
    {
        ...
        $this->createIndex('{{%idx-auth_assignments-user_id}}', $authManager->assignmentTable, 'user_id');
    ...
    public function down()
    {
        ...
        $this->dropIndex('{{%idx-auth_assignments-user_id}}', $authManager->assignmentTable);
