...
/* @var $searchModel core\entities\Chemical\ChemicalSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'Chemicals');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="chemical-index">

    <span class="button-panel">
        <?= Html::a('<i class="fa fa-plus-square"></i> ' . Yii::t('app', 'Create Chemical'), ['create'], ['class' => 'btn btn-success']) ?>
